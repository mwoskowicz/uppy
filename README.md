...
Add CSS [uppy.min.css](https://transloadit.edgly.net/releases/uppy/v0.22.7/dist/uppy.min.css), either to `<head>` of your HTML page or include in JS, if your bundler of choice supports it — transforms and plugins are available for Browserify and Webpack.
...
``` html
<script src="https://transloadit.edgly.net/releases/uppy/v0.22.7/dist/uppy.min.js"></script>
```

2\. Add CSS to `<head>`:
``` html
<link href="https://transloadit.edgly.net/releases/uppy/v0.22.7/dist/uppy.min.css" rel="stylesheet">
```
